...
namespace KamilKielczewskiPWI.Controllers
{
    public class PeopleController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PersonId,LastName,FirstName,HireDate,EnrollmentDate")] Person person)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PersonId,LastName,FirstName,HireDate,EnrollmentDate")] Person person)
        {
